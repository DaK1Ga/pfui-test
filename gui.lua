pfUI:RegisterModule("gui", function ()
  ...
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Group Layout", pfUI_config.unitframes.group, "group_layout", "dropdown", { "group", "raid" })
  pfUI.gui:CreateConfig(pfUI.gui.uf, "Health width", pfUI_config.unitframes.group, "width")
